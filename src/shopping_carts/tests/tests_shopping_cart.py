...
@pytest.mark.asyncio
async def test_get_cart(async_client: AsyncClient) -> None:
...
@pytest.mark.asyncio
async def test_create_cart(async_client: AsyncClient) -> None:
...
@pytest.mark.asyncio
async def test_add_item_to_cart(async_client: AsyncClient) -> None:
    movie_id = 1
...
@pytest.mark.asyncio
async def test_remove_item_from_cart(async_client: AsyncClient) -> None:
    item_id = 1
...
@pytest.mark.asyncio
async def test_clear_cart(async_client: AsyncClient) -> None:
...
@pytest.mark.asyncio
async def test_admin_get_user_cart(async_client: AsyncClient) -> None:
    user_id = 1
...
@pytest.mark.asyncio
async def test_admin_add_movie_to_cart(async_client: AsyncClient) -> None:
...
@pytest.mark.asyncio
async def test_admin_remove_movie_from_cart(async_client: AsyncClient) -> None:
    user_id, movie_id = 1, 2
...
@pytest.mark.asyncio
async def test_admin_clear_user_cart(async_client: AsyncClient) -> None:
    user_id = 1
